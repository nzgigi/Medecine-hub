  ...
  return (
    <div className="group relative bg-white dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-800">
      ...
      <div className="relative p-6">
        ...
        <div
          className={`w-16 h-16 rounded-xl bg-gradient-to-br ${gradient} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
        >
        ...
        <div className="flex flex-wrap gap-2">
          {annees.map((annee) => (
            <Link
              key={annee}
              href={`/qcm/${slug}/${annee}`}
              className="px-4 py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-200 rounded-lg text-sm font-semibold border-2 border-blue-100 dark:border-blue-700 hover:bg-blue-600 hover:text-white hover:border-blue-600 dark:hover:bg-blue-500 dark:hover:border-blue-500 hover:scale-105 hover:shadow-md transition-all duration-200"
