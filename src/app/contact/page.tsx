    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-900 py-12">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Left Column - Info */}
          <div>
            <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-8 mb-6 border border-gray-100 dark:border-gray-800">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-blue-600 dark:text-blue-300 hover:text-blue-700 dark:hover:text-blue-200"
                    >
                      nasimzouh@gmail.com
                    </a>
                  </div>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl shadow-xl p-8 text-white">
              ...
              <p className="text-blue-100 mb-4">
                Consultez nos sources ou nos mentions légales pour plus
                d&apos;informations sur la plateforme.
              </p>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-8 border border-gray-100 dark:border-gray-800">
            ...
            {status === "success" && (
              <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-600 rounded-xl flex items-start gap-3">
            ...
            {status === "error" && (
              <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-600 rounded-xl flex items-start gap-3">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border-2 rounded-xl bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 transition-all ${
                    errors.name
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={6}
                  className={`w-full px-4 py-3 border-2 rounded-xl bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 transition-all resize-none ${
                    errors.message
                      ? "border-red-300 dark:border-red-500 focus:border-red-500 focus:ring-red-200"
                      : "border-gray-200 dark:border-gray-700 focus:border-blue-500 focus:ring-blue-200"
                  }`}
